    ...
    Container(
        ...
        children: <Widget>[
          ...
          onSaved: (String val) {
            ...
            Container( padding: EdgeInsets.only(left: 16.0,right:16.0,top: 8.0),
            child:
              Text("From:",style: TextStyle(fontSize: 15.0,fontWeight: FontWeight.w300,)),
            ),
          ...
          data: new ThemeData(
            ...
            DateTimePickerFormField(
              ...
              onChanged: (dt) => setState(() => fromTime= dt),
            ),
           )),
           Container( padding: EdgeInsets.only(left: 16.0,right:16.0,top: 8.0),
            child:
              Text("To:",style: TextStyle(fontSize: 15.0,fontWeight: FontWeight.w300,)),
            ),
          ...
          data: new ThemeData(
            ...
            DateTimePickerFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'From',
                  labelText: 'Time', hasFloatingPlaceholder: false),
              onChanged: (dt) => setState(() => toTime= dt),
            ),
           )),
            Container(
                padding: EdgeInsets.only(left: 16.0,right:16.0,top: 16.0),
          ...
          data: new ThemeData(
            ...
            duration= val;
              ...
              Container( padding: EdgeInsets.only(left: 16.0,right:16.0,top: 16.0,bottom: 8.0),
            child:
              Text("Faculty Coordinator",style: TextStyle(fontSize: 15.0,fontWeight: FontWeight.w500,)),
            ),
              Container(
                padding: EdgeInsets.only(left: 16.0,right:16.0,top: 16.0),
                  child: new Theme(
         ...
         onSaved: (String val) {
          ...
          Container( padding: EdgeInsets.only(left: 16.0,right:16.0,top: 16.0,bottom: 8.0),
            child:
              Text("Student Coordinator",style: TextStyle(fontSize: 15.0,fontWeight: FontWeight.w500,)),
            ),
              Container(
                padding: EdgeInsets.only(left: 16.0,right:16.0,top: 16.0),
                  child: new Theme(
...
void _processData() {
 ...
 var response=await http.post(URL_CREATEEVENT,headers: {"authentication": "$token"}, body: json.encode(body));

    
   final data = json.decode(response.body);
      print(data['rs']);

       Toast.show(data['rs'].toString(), context, duration:Toast.LENGTH_SHORT, gravity: Toast.BOTTOM);
        _processData();
  }
   ...
   return FutureBuilder(
      ...
      //  Toast.show( "Check Your Connection", duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM);
         Toast.show("Check Your Connection", context, duration:Toast.LENGTH_SHORT, gravity: Toast.BOTTOM);
          }
          });
